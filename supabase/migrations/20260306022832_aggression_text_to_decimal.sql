ALTER TABLE "user_profiles" DROP CONSTRAINT IF EXISTS "user_profiles_aggression_check";--> statement-breakpoint
...
ALTER TABLE "user_profiles" ALTER COLUMN "aggression" SET DATA TYPE numeric(2, 1) USING "aggression"::numeric(2, 1);--> statement-breakpoint
