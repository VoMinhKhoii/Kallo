...
Usage:
    python3 scripts/data/usda/download_usda_sr.py --api-key YOUR_KEY --out data/usda_sr
    python3 scripts/data/usda/download_usda_sr.py --api-key YOUR_KEY --out data/usda_sr --dry-run
