 ...
 *
 * Usage:
 *   bun --env-file=.env.local scripts/ops/reset-analysis-guards.ts
 *   bun --env-file=.env.local scripts/ops/reset-analysis-guards.ts --route=/api/analyze-meal
 *   bun --env-file=.env.local scripts/ops/reset-analysis-guards.ts --windows  # also clear minute/hour/day windows
 */
