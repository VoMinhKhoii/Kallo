...
import { invalidateFeedQueries } from '@/lib/domain/social/feed/feed-cache';
import { mergeConfirmedMealIntoDay, upsertMealIntoList } from './day-cache';
...
// out from the optimistic-meal builders in this folder so each file stays a
// single concern (and under the file-size limit).
// ---------------------------------------------------------------------------
