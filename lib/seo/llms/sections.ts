...
export const WHEN_TO_USE = [
  ...
  '- **Reading a nutrition label from a photo.** Returns what it read and logs',
  '  no meal. The photo and the scan outcome are kept privately with the',
  '  account — visible to its owner and the Kallo team — until it is deleted.',
  '',
