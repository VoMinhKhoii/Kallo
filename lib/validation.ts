 ...
 * meal. Defined here (the lowest-level validation module) so both the meals
 * contract and the analyze-meal request body reuse ONE schema — the picks a
 * combined submit sends alongside free text validate identically to a pure
 * relog.
 */
