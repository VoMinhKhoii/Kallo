...
import type { GrantMutationDeps } from '@/lib/billing/entitlement/grants';
import type { BillingEnvironment } from '@/lib/billing/revenuecat/identity';
import {
  claimRevenueCatOwnershipEvent,
  StaleOwnershipEventError,
} from '@/lib/billing/revenuecat/ownership';
import { reconcileRevenueCatGrantsInTransaction } from '@/lib/billing/revenuecat/projection';
