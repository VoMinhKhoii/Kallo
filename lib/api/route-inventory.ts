 ...
 *    (`readBoundedJson`, `readJsonBody` -- which delegates to it -- or
 *    `readBoundedWebhookBody`) or an explicit content-length guard, rather
 *    than an unbounded `req.json()` / `formData()`.
...
export const routeInventory = {
  ...
  'api/v1/chat-groups/[groupId]/route.ts': ['session', true, 'none-cheap'],
  'api/v1/chat-groups/route.ts': ['session', true, 'none-cheap'],
  'api/v1/dashboard/heatmap/route.ts': ['session', false, 'none-cheap'],
  'api/v1/dashboard/route.ts': ['session', false, 'none-cheap'],
  'api/v1/feedback/route.ts': ['session', true, 'none-cheap'],
  ...
  'api/v1/groups/invites/accept/route.ts': ['session', true, 'none-cheap'],
  'api/v1/groups/invites/dismiss/route.ts': ['session', true, 'none-cheap'],
  'api/v1/groups/invites/route.ts': ['session', false, 'none-cheap'],
  'api/v1/groups/meal-share/route.ts': ['session', true, 'none-cheap'],
  'api/v1/groups/profile/avatar/route.ts': ['session', true, 'avatarUpload'],
  'api/v1/groups/profile/name/route.ts': ['session', true, 'none-cheap'],
  'api/v1/groups/profile/route.ts': ['session', true, 'none-cheap'],
  'api/v1/groups/shares/[shareId]/route.ts': ['session', false, 'none-cheap'],
  'api/v1/groups/shares/log/route.ts': ['session', true, 'none-cheap'],
  ...
  'api/v1/groups/shares/route.ts': ['session', true, 'none-cheap'],
  ...
  'api/v1/meals/[mealId]/duplicate/route.ts': ['session', true, 'none-cheap'],
  'api/v1/meals/[mealId]/route.ts': ['session', true, 'none-cheap'],
  'api/v1/meals/cheat-occasions/route.ts': ['session', false, 'none-cheap'],
  'api/v1/meals/cheat-repeat/route.ts': ['session', true, 'none-cheap'],
  'api/v1/meals/confirm/route.ts': ['session', true, 'none-cheap'],
  'api/v1/meals/dates/route.ts': ['session', false, 'none-cheap'],
  'api/v1/meals/manual/route.ts': ['session', true, 'none-cheap'],
  ...
  'api/v1/meals/relog/route.ts': ['session', true, 'analysis-guard'],
  'api/v1/meals/relog/stage/route.ts': ['session', true, 'analysis-guard'],
  'api/v1/meals/route.ts': ['session', false, 'none-cheap'],
  'api/v1/notifications/badge/route.ts': ['session', false, 'none-cheap'],
  'api/v1/notifications/push-tokens/route.ts': ['session', true, 'none-cheap'],
  ...
  'api/v1/weight/route.ts': ['session', true, 'none-cheap'],
