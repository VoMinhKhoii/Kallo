...
* **circle:** confirm before accepting or dismissing a meal-share offer ([9eed755](https://github.com/VoMinhKhoii/Kallo/commit/9eed755c087d1885f6ecb7e4fbf67c483c4bb62e))
* **circle:** one reply pill, a centred empty state and pull-to-refresh ([6b03e8e](https://github.com/VoMinhKhoii/Kallo/commit/6b03e8e471b7c358762b170bba0270a1c6fec260))
* **circle:** rebuild the thread reply surface on mobile and web ([4a58cd2](https://github.com/VoMinhKhoii/Kallo/commit/4a58cd27258b2528869574a513290655d999af1d))
* **dashboard:** plot weight by calendar day and restyle to a rounded spline ([9a49075](https://github.com/VoMinhKhoii/Kallo/commit/9a490757b9e3d326d07525a9f1825d00a3d5b042))
* **dashboard:** plot weight by calendar day and restyle to a rounded spline ([c38b80b](https://github.com/VoMinhKhoii/Kallo/commit/c38b80bd6add227ae9910410041d02d533173428))
...
* **logging:** add a calendar picker to the timeline sidebar ([8cec058](https://github.com/VoMinhKhoii/Kallo/commit/8cec058b6921960ef7b3aa180efc391a9c909d08))
* **logging:** let the desktop timeline reach an unlogged day ([661a5cc](https://github.com/VoMinhKhoii/Kallo/commit/661a5cc28d6c94edb3e0b1da1afc8bf91704747d))
* **logging:** open the calendar as a dialog instead of a popover ([c7af872](https://github.com/VoMinhKhoii/Kallo/commit/c7af872ed2c1d65247edbe12b141d8b72f83a96a))
* **logging:** per-day totals, a calendar picker, and one voice on the meal turn ([2bbda7f](https://github.com/VoMinhKhoii/Kallo/commit/2bbda7f3247d2bd162e9f4d401af047cf3f9940c))
* **logging:** show each day's calorie total in the timeline ([191c4e9](https://github.com/VoMinhKhoii/Kallo/commit/191c4e9721bd2b5f6387f02af2c1485939b6cc6d))
* **mobile:** cheat-meal sharing, and the copy-only share sheet ([a6d4bc9](https://github.com/VoMinhKhoii/Kallo/commit/a6d4bc9bc6a8ae2b5447ac2075876ca3dea79ce9))
* **mobile:** draw real squircles, and take CupertinoSwitch directly ([5502ebb](https://github.com/VoMinhKhoii/Kallo/commit/5502ebbc3346247abd00be1470bb3313baf5725c))
* **mobile:** give the eight silent controls their iOS haptic ([29664d6](https://github.com/VoMinhKhoii/Kallo/commit/29664d69d01673f49bb583edca54e5e5b8ba52a9))
* **mobile:** portion battery ([610ebc2](https://github.com/VoMinhKhoii/Kallo/commit/610ebc2eaecfbd03b246f177f3eebe8074fbc5bf))
* **mobile:** remove non-nativeness from custom components ([62967cd](https://github.com/VoMinhKhoii/Kallo/commit/62967cdedb0885b61fef87f5d8b29db96569f779))
...
* **social:** discarding a staged cheat card hands the offer back ([966499d](https://github.com/VoMinhKhoii/Kallo/commit/966499d79cf3d15c34b7cff236ff1934ce734816))
* **social:** make a shared cheat meal read as one in the circle feed ([b92556a](https://github.com/VoMinhKhoii/Kallo/commit/b92556a1c991a56313411e4f406337d92d4c795e))
* **social:** share a cheat meal to a friend, amount set by the recipient ([eddefe7](https://github.com/VoMinhKhoii/Kallo/commit/eddefe7fdd82b55610f922874b6b9b58bc8951c4))
* **social:** share a cheat meal, keep the original time, stack the invite inbox ([629e475](https://github.com/VoMinhKhoii/Kallo/commit/629e475759f96e44d699979073039e6d5682f2b7))
* **social:** split parts maths ([777772e](https://github.com/VoMinhKhoii/Kallo/commit/777772e11efdeec81e548041b8d5f404eae79c52))
* **social:** stack pending meal offers into one deck ([7a0bf62](https://github.com/VoMinhKhoii/Kallo/commit/7a0bf62cf9324b8db3cdf8b5983f8e7d550445ba))
...
* address Codex review on the invite confirm and discard test ([dacfaa7](https://github.com/VoMinhKhoii/Kallo/commit/dacfaa765f3affbb479a5dadcfadbfc2d38beba9))
* **circle:** a failed refresh keeps the post, and the pull waits for it ([b1bf6f1](https://github.com/VoMinhKhoii/Kallo/commit/b1bf6f17f061d0b4e48016ca7e7aac0abafcc42c))
* **circle:** a send button a screen reader can actually activate ([d6f1499](https://github.com/VoMinhKhoii/Kallo/commit/d6f149925773d76ca0a050b7ffc2b4e53666fc10))
* **circle:** a swapped-in thread opens at its own top ([50428db](https://github.com/VoMinhKhoii/Kallo/commit/50428db851e3c918c098e1ca2cf5ef930ef63cc2))
* **circle:** hold the thread's post across a refetch underneath it ([84d6e31](https://github.com/VoMinhKhoii/Kallo/commit/84d6e31e9e63d4f759d26196d52d6476f7434dee))
* **circle:** key the reply dock on the share, not the whole thread ref ([db8dbb0](https://github.com/VoMinhKhoii/Kallo/commit/db8dbb02ca44c8301992436abe3cd596e2283263))
* **circle:** nothing from one thread survives into another ([053ad67](https://github.com/VoMinhKhoii/Kallo/commit/053ad67349da4635808b4b9cd47aae7fc6af2460))
* **circle:** refresh only the source the thread page is reading ([9e00da8](https://github.com/VoMinhKhoii/Kallo/commit/9e00da84d77e640b8c829b95c27e292b07486cd1))
* **circle:** the send button stands as tall as the field it sends ([09b12a7](https://github.com/VoMinhKhoii/Kallo/commit/09b12a76865eb12808bb3e838dd8f771576772d0))
* **circle:** the send glyph drops one tier, primary to action ([3c8c269](https://github.com/VoMinhKhoii/Kallo/commit/3c8c26958285baf12d9d805c8053e279d9c7ff84))
* **circle:** the share is the thread page's identity, not the whole ref ([73b9d2e](https://github.com/VoMinhKhoii/Kallo/commit/73b9d2e2b38969081832ef1797ef8bd7d6222751))
* **circle:** uniform inset in the reply pill, send button outside it ([713eb69](https://github.com/VoMinhKhoii/Kallo/commit/713eb69e1c4a6dd489e9719deff99a0cd6d52f94))
...
* **logging:** agree on the abandoned horizon; clear the parked day on sign-out ([7f5f42d](https://github.com/VoMinhKhoii/Kallo/commit/7f5f42d58c320cff21a4a8ea1213b56bf778f6c3))
* **logging:** agree with the feed on which staged cards are live ([9e6c6f6](https://github.com/VoMinhKhoii/Kallo/commit/9e6c6f601161580c5e107d5745497ddc5c26dfe9))
* **logging:** drop the day total when a pending card shares the day ([182ba98](https://github.com/VoMinhKhoii/Kallo/commit/182ba982a8d68996f39389ee691f30554bb30b2f))
* **logging:** give the meal card's expand toggle a real touch target ([e3673c8](https://github.com/VoMinhKhoii/Kallo/commit/e3673c823159c1bf6c85db4719bc649759bc9ac4))
* **logging:** localize the calendar and refresh totals after an edit ([d26585f](https://github.com/VoMinhKhoii/Kallo/commit/d26585fffb93c499b375c44b53c0f9e08c4d7c5e))
* **logging:** localize the labels DayPicker writes, not just the dates ([3e70aaa](https://github.com/VoMinhKhoii/Kallo/commit/3e70aaafef294b5276db9bd4e2cf47e888e5188b))
* **logging:** never report a partial day total as a complete one ([ec2795e](https://github.com/VoMinhKhoii/Kallo/commit/ec2795ecb26f59a3ad1c8cbd6c5357e606583740))
* **logging:** put the meal turn on one voice and one body size ([5e2c15d](https://github.com/VoMinhKhoii/Kallo/commit/5e2c15ddaa6c2138e0a4dbcdf696ee911caccde8))
* **logging:** read the scan boundary off the probe row ([689791a](https://github.com/VoMinhKhoii/Kallo/commit/689791a94d041075f8a51b5dd2c90daa7d15a1ae))
* **logging:** read the timeline's three scans from one snapshot ([4ea6ddc](https://github.com/VoMinhKhoii/Kallo/commit/4ea6ddc214302b2b9067748e35c0ea32bc93207e))
* **logging:** reconcile the day read with the sweep running beside it ([c5154b6](https://github.com/VoMinhKhoii/Kallo/commit/c5154b65543c53ad5ad826a188c45ac138fae7bb))
* **logging:** share one definition of a renderable staged card ([2010bea](https://github.com/VoMinhKhoii/Kallo/commit/2010bea87da958026cab4b0568d8829c4cf4df6f))
* **logging:** start the calendar's week on Monday ([b0c52d6](https://github.com/VoMinhKhoii/Kallo/commit/b0c52d6b350ccf07cb7a0a4ce6c2aa3a84f5c72d))
* **logging:** take the union of both pending scans ([47fc10e](https://github.com/VoMinhKhoii/Kallo/commit/47fc10ec78ad109fcdf7afcd2921686dfa5ab560))
...
* **mobile:** a discard or delete survives leaving the feed during undo ([8696cf1](https://github.com/VoMinhKhoii/Kallo/commit/8696cf108e36862c7b67f1a0e003404613c3a537))
* **mobile:** act on the pre-PR review — two real bugs and four bad abstractions ([5cabdfc](https://github.com/VoMinhKhoii/Kallo/commit/5cabdfca40417e6975ea50ff382621be9ee18983))
...
* **mobile:** carry drags into the switch's expanded tap target ([f6076cf](https://github.com/VoMinhKhoii/Kallo/commit/f6076cf366b8931e18a07f7ec55dcdd770ecabad))
...
* **mobile:** give the toast its exit curve, and a way to be dismissed ([78bc298](https://github.com/VoMinhKhoii/Kallo/commit/78bc298f6c9c0643495c3d008638a6d37f4d785d))
* **mobile:** land the pace ruler's fling on a graduation in one motion ([66df508](https://github.com/VoMinhKhoii/Kallo/commit/66df508f4d3258904e381a0d166202aed6716b04))
* **mobile:** make the 44pt switch band real, and stop the double tick ([9a2179f](https://github.com/VoMinhKhoii/Kallo/commit/9a2179f4cb93a7bbab031744ba4fd3218fc3f7fc))
* **mobile:** reach the 44pt floor, dismiss the keyboard on drag, drop the tooltip ([56d3991](https://github.com/VoMinhKhoii/Kallo/commit/56d3991f4d992ccb6cb5ce22a2f69fa881773b9b))
* **mobile:** stop the switch claiming taps meant for its whole row ([f79e9d3](https://github.com/VoMinhKhoii/Kallo/commit/f79e9d372ddbfed8ab537e85892516f1a67c1066))
...
* refine weight and settings interactions ([20e8e54](https://github.com/VoMinhKhoii/Kallo/commit/20e8e544ecd896b08778ce658a7d088d73d9f929))
* refine weight and settings interactions ([c6f89fc](https://github.com/VoMinhKhoii/Kallo/commit/c6f89fc976048db4aec49c6bb4ef7fbed94b6089))
...
* **social:** a re-share reaches a friend who deleted their accepted copy ([7e01e4a](https://github.com/VoMinhKhoii/Kallo/commit/7e01e4a6bc1887f06c7857c7be8a0fcf705ebe93))
* **social:** act on the close-out review — a guard that caused the bug it prevented ([27c5a15](https://github.com/VoMinhKhoii/Kallo/commit/27c5a15ae271f828f6c2acf8f1bdca91b53da5cd))
* **social:** act on the codex review — two caches that hid a completed write ([d832b8b](https://github.com/VoMinhKhoii/Kallo/commit/d832b8bb2daa2bfb0f9c214ac358a6d3842e133a))
* **social:** act on the deck review — one bug that hid the feature ([5dcc342](https://github.com/VoMinhKhoii/Kallo/commit/5dcc34291b9919af34bc07a2308a329c03618948))
* **social:** act on the pre-PR review — two real bugs and a vacuous test ([8becbf2](https://github.com/VoMinhKhoii/Kallo/commit/8becbf241ba3568c26ec0704db352e52b607c3c7))
...
* **social:** keep the original meal's time on an accepted share ([f20cad8](https://github.com/VoMinhKhoii/Kallo/commit/f20cad8df4969b99491a5aed18e6ead27f5702bf))
* **social:** re-shared meals come back, and confirm before accept/dismiss ([1f3e2e2](https://github.com/VoMinhKhoii/Kallo/commit/1f3e2e27d01c6d0a1471d5bde5fb482ca62b93c9))
...
* **logging:** bound the timeline's staged-card scan ([c8c69a1](https://github.com/VoMinhKhoii/Kallo/commit/c8c69a109cbfbb7558b4af5f2d67156777b5950b))


### Refactor

* **circle:** one home per number, and a disabled send button that stays quiet ([2c72367](https://github.com/VoMinhKhoii/Kallo/commit/2c7236703e5535699d91ca8ec07f55f605056a5d))
* **dashboard:** let the empty weight plot speak for itself ([b72170c](https://github.com/VoMinhKhoii/Kallo/commit/b72170cc27c8834dfebb45645d7f558b116199a1))
* **logging:** delete the pipeline this branch orphaned ([fa350b2](https://github.com/VoMinhKhoii/Kallo/commit/fa350b269144a67c4dfc700ffc4c7a66ccd9c4e9))
* **logging:** name what the timeline knows about a day ([29ba897](https://github.com/VoMinhKhoii/Kallo/commit/29ba897d88a5caf2e52d41e3303f335669cf6ae8))
* **logging:** name what the timeline knows about a day ([c929388](https://github.com/VoMinhKhoii/Kallo/commit/c929388574d7d1a32dae2df554489962ea929157))
* **logging:** split the timeline's date index out of load-meals ([ee53b10](https://github.com/VoMinhKhoii/Kallo/commit/ee53b10d7c874623e8cbce3a97dea6b55395a7fc))
...
* **mobile:** swap every Material spinner for CupertinoActivityIndicator ([b10b227](https://github.com/VoMinhKhoii/Kallo/commit/b10b2274b8cac036d6919e883707ca1f27fae2d8))
...
* simplify the invite confirm and undo-window delete paths ([d8b326f](https://github.com/VoMinhKhoii/Kallo/commit/d8b326f009c7d9735e9277e77ac9c7d18d3ab0a0))
* **social:** a cheat post is an ordinary post with a chip ([a8a3988](https://github.com/VoMinhKhoii/Kallo/commit/a8a398811a08cdf6f30d9a756940b378c2540aae))
* **social:** a cheat post is the chip, the meal and one figure ([9823d57](https://github.com/VoMinhKhoii/Kallo/commit/9823d57e75176cf8ee0fd6e5deed2b3bf4f86e05))
...
* **social:** one claim path for both ways of taking an invite ([a19ec15](https://github.com/VoMinhKhoii/Kallo/commit/a19ec151cd2b7963edde3cc277ec9e9ad71e4a1e))
...
* **mobile:** invert the burden of proof in the Cupertino rule ([bbf89bb](https://github.com/VoMinhKhoii/Kallo/commit/bbf89bb6ee74cbe56d40b74952f90770c6f9bf6b))
...
* **social:** keep the reverted-widening note on inviteStillHeld ([3159c31](https://github.com/VoMinhKhoii/Kallo/commit/3159c31adec9a10a2b41cf270a1959eadbb7b156))
...
* **analytics:** expose bounded raw meal text ([aeef79d](https://github.com/VoMinhKhoii/Kallo/commit/aeef79d7104e17cacd5cadc3909017ff13206551))
...
* **circle:** Threads-style feed and thread page, notifications open the post, menu and state fixes ([f130249](https://github.com/VoMinhKhoii/Kallo/commit/f1302496639faded85cbdc2b6588e95aacab4bcd))
* **dashboard:** one green ramp that stops at target, one colour past it ([cbfeca0](https://github.com/VoMinhKhoii/Kallo/commit/cbfeca05cb7d328650e6b4deecfc336730b9fc5a))
* **db:** add day_completion_marks for user-attested full days ([bf9bfa5](https://github.com/VoMinhKhoii/Kallo/commit/bf9bfa50b44346382af65636e7441d9a72a193de))
* expose bounded meal input to analytics trace ([153cd93](https://github.com/VoMinhKhoii/Kallo/commit/153cd93b5f9c835d123c6340455856fd4f0f6095))
* **logging:** a scanned product is a composer pick, and the meal keeps its name ([dd37ee1](https://github.com/VoMinhKhoii/Kallo/commit/dd37ee1d4cc4d4b42f5304194642cb35b511441f))
* **logging:** let a user attest an under-logged day ("Mình ăn đủ rồi") ([be99db5](https://github.com/VoMinhKhoii/Kallo/commit/be99db5a0327eaabee510c678eda0dbb0a5cbbc8))
* **logging:** let web users mark an under-logged day complete ([20c92ca](https://github.com/VoMinhKhoii/Kallo/commit/20c92caa6231f4e54c8037ca36b97c9c8a30ca59))
* **logging:** mark a day complete from the server side ([58c790d](https://github.com/VoMinhKhoii/Kallo/commit/58c790d42325c01bb34bb5e3a5f42d0276e72f07))
* **mobile:** a right swipe on an onboarding screen steps back ([64ea913](https://github.com/VoMinhKhoii/Kallo/commit/64ea913aefd18be19f9e41f2dc031988fe39b348))
* **mobile:** a share notification tap opens that post's thread ([5ca9da9](https://github.com/VoMinhKhoii/Kallo/commit/5ca9da9f4594bd14773f2bbc4b8ee598bf0a04b3))
* **mobile:** add "Mình ăn đủ rồi" to the under-logged notice ([7e31ecf](https://github.com/VoMinhKhoii/Kallo/commit/7e31ecfaced9ef000e5bd30ff52b87a91ed7c212))
...
* **mobile:** Circle feed card and thread page read like Threads ([40e1cbe](https://github.com/VoMinhKhoii/Kallo/commit/40e1cbe3d9bcc770471b54110cc5080d6e887578))
...
* **mobile:** micronutrients as a 2-column grid of cards ([66f6ac8](https://github.com/VoMinhKhoii/Kallo/commit/66f6ac8fc5b19440643bf70c9e99f146e3e0c25f))
* **mobile:** onboarding-first flow, animated bun guide, gold-yearly paywall ([983f294](https://github.com/VoMinhKhoii/Kallo/commit/983f2941578cb32a8581026561f950cdf09f5037))
* **mobile:** port the heatmap's range chooser so iPad shows a year ([2844bab](https://github.com/VoMinhKhoii/Kallo/commit/2844babeaa2be29a47c911045cef2e5e9f3480c8))
...
* **mobile:** rebuild the paywall around a Free vs Pro comparison ([871d684](https://github.com/VoMinhKhoii/Kallo/commit/871d684a48dce4c1e3d15b569d5af29c8f63979f))
* **mobile:** stable-chrome step transitions, BMI goal default, email route, top sweep ([409774f](https://github.com/VoMinhKhoii/Kallo/commit/409774f3ea910292c74da8052ea25925c33596ce))
* **mobile:** start-screen dish scatter, step backdrop blobs, slimmer tests ([6932238](https://github.com/VoMinhKhoii/Kallo/commit/69322386d1e252748ba171fd75ca137cbb95edf7))
* **mobile:** tapping anywhere on a Circle post opens its thread ([89db7da](https://github.com/VoMinhKhoii/Kallo/commit/89db7dac463afff476c46de17e97c3c9256201d4))
* **mobile:** the back gesture starts anywhere on the page, not on a 20pt edge ([823d6cd](https://github.com/VoMinhKhoii/Kallo/commit/823d6cdffc265d8a79877f614350079c0fa93b5e))
* **mobile:** the message menu is the app's own, and the bubble stays put ([635cbbd](https://github.com/VoMinhKhoii/Kallo/commit/635cbbdd855f31b65cac150d445d63a7494f038b))
* **mobile:** the thread page fetches a post the feed cache does not hold ([e2984f4](https://github.com/VoMinhKhoii/Kallo/commit/e2984f48f97948b82b3b0ef4e8a35a6916ea8f3f))
* **notifications:** push carries the share it is about ([620740c](https://github.com/VoMinhKhoii/Kallo/commit/620740cfd706d38546f166b2b2b30b1ad8e5c918))
* **nutrition:** let an attested day override the partial-day gate ([1c41b26](https://github.com/VoMinhKhoii/Kallo/commit/1c41b2611713dfca5ffe96b57df579cb6e437ace))
* **nutrition:** NASEM fiber Adequate Intake for every profile ([7e3e4c5](https://github.com/VoMinhKhoii/Kallo/commit/7e3e4c579db0c5949a73eab303ef4c68707fd6bd))
* **push:** send to APNs directly and register the iOS device ([0986dbd](https://github.com/VoMinhKhoii/Kallo/commit/0986dbd19d482c659330d235a9938db4722c81f9))
...
* **web:** a post's own page at /circle/&lt;shareId&gt; ([e03578e](https://github.com/VoMinhKhoii/Kallo/commit/e03578e994218e3a200e0b4c5e7188c90c5fa688))
...
* **analytics:** restore trace reader grants ([de05b5b](https://github.com/VoMinhKhoii/Kallo/commit/de05b5b0255716a209f48f53ec3f2756e1936b1f))
* **analytics:** restore trace reader grants ([7ccb289](https://github.com/VoMinhKhoii/Kallo/commit/7ccb28934f7837b6765b362a91d245f040dbfff5))
* **dashboard:** drop the duplicated window label, restyle the attest button ([92688c2](https://github.com/VoMinhKhoii/Kallo/commit/92688c208133182502a392dd2b74ee328c357110))
* **dashboard:** make the heatmap key describe the grid, and pin it with goldens ([51a2ba5](https://github.com/VoMinhKhoii/Kallo/commit/51a2ba5e72c27ecf73cf926c6bd6267e2bdcae84))
* **dashboard:** make the heatmap legend describe the grid it sits under ([bc13198](https://github.com/VoMinhKhoii/Kallo/commit/bc13198ca61ac76be8c0246fd732d469c772bc8d))
* honour an attested day on every surface that reads the gate ([727b100](https://github.com/VoMinhKhoii/Kallo/commit/727b10081d9e8d2c4b7f472ed33575a78dac7b48))
* **i18n:** the Instant mode reads "Tính ngay" in Vietnamese ([fed5ea9](https://github.com/VoMinhKhoii/Kallo/commit/fed5ea9e5b48724296982c6540b79823890c6eed))
* **ios:** drive aps-environment from a per-configuration build setting ([ed75851](https://github.com/VoMinhKhoii/Kallo/commit/ed75851cb02abb93d94efde95a74b7b4b015b08d))
* **logging:** picks keep their order and their hygiene, and a stale scan is refused up front ([1dcb4ee](https://github.com/VoMinhKhoii/Kallo/commit/1dcb4ee9ae4f865217fe6a64ac8f4b620f7b92fd))
* **logging:** the composer's picks — keyboard, order, scanned products, and a calm feed ([9bde362](https://github.com/VoMinhKhoii/Kallo/commit/9bde362d5a937d3b4a78298558df3fff9385da13))
* **mobile,web:** brand-sweep tab bar "+", 7d nutrition default, closable paywall, Google grant reuse ([fe32767](https://github.com/VoMinhKhoii/Kallo/commit/fe32767be47dabc5ba51246048d8a43fb6f0e471))
* **mobile,web:** guard brand names from capitalisation; web heart in web's red ([786a61e](https://github.com/VoMinhKhoii/Kallo/commit/786a61ea798574e91f110d1f60abb3a0a7dd0677))
* **mobile,web:** recent meals order, Circle thread page, dialog surface, nutrient grid ([024af82](https://github.com/VoMinhKhoii/Kallo/commit/024af825f59b2fce356b2b2d3e7acbb301f77a46))
* **mobile,web:** recent-meals order, Circle thread page, dialog surface ([870996f](https://github.com/VoMinhKhoii/Kallo/commit/870996ff8ac50dbf79046827b558dea2ca5e6507))
* **mobile:** a build exception no longer bricks the app into a grey rectangle ([e6eb325](https://github.com/VoMinhKhoii/Kallo/commit/e6eb325185083df4b8b5989b35a8cb0fd4b49fbe))
* **mobile:** a disabled glyph inside a post absorbs its tap ([ab78c1e](https://github.com/VoMinhKhoii/Kallo/commit/ab78c1ea371c25d5f455547e471515ed710040ec))
* **mobile:** a scanned pick never splits, drops, or outlives another pick ([b967562](https://github.com/VoMinhKhoii/Kallo/commit/b96756203763128d245050294b28450347d32512))
* **mobile:** act on CodeRabbit's review of [#353](https://github.com/VoMinhKhoii/Kallo/issues/353) ([38cf2d5](https://github.com/VoMinhKhoii/Kallo/commit/38cf2d53d33304b5069918ca4b0b5cc581141523))
* **mobile:** app-wide swipe-back, Circle polish, onboarding back-stack, and a Free vs Pro paywall ([70a7630](https://github.com/VoMinhKhoii/Kallo/commit/70a76304ca6abcb9feffa42577f53a1d420e17bc))
* **mobile:** audience the iOS Google token to the iOS client, not the Web one ([a56e086](https://github.com/VoMinhKhoii/Kallo/commit/a56e0863b77cff8b4689fe2e78e3c7a40922b3d1))
* **mobile:** Circle action row presses with a wash, not a ripple ([4d583da](https://github.com/VoMinhKhoii/Kallo/commit/4d583dae5e842349a21af42b1353364a9f5a79c3))
* **mobile:** closing the scan sheet is not a request to log or scroll ([c6ca19b](https://github.com/VoMinhKhoii/Kallo/commit/c6ca19b7166eb35ddbcb1b091fd90eeae4f89a6f))
* **mobile:** device-pass fixes — paywall, bubble tail, back-gesture timing, and a reportable error screen ([afe67e8](https://github.com/VoMinhKhoii/Kallo/commit/afe67e84457340a2e8884f3e20b1d402abcc5f2e))
* **mobile:** device-pass fixes for the paywall, the bubble tail and the back gesture ([1275402](https://github.com/VoMinhKhoii/Kallo/commit/12754025b80387e185fa4db28ed8a4b166ca1726))
* **mobile:** empty and failed states sit in the middle of their region ([b6d05d5](https://github.com/VoMinhKhoii/Kallo/commit/b6d05d5efd43b207803b6e473e28bb7feceb911f))
* **mobile:** even out the Circle action row and restore the thread's cast ([b9421b3](https://github.com/VoMinhKhoii/Kallo/commit/b9421b3f106e224c6466fde188902ae3da1cd5d4))
* **mobile:** every macro-bar segment is its own pill ([203908f](https://github.com/VoMinhKhoii/Kallo/commit/203908f8f8c5c2fe4521f38257e772fb8f5d6884))
* **mobile:** KalloPressable shrink-wraps, so the post action row is one row ([bc9ffdb](https://github.com/VoMinhKhoii/Kallo/commit/bc9ffdb2654a0c6f6986c1f90366e0b4127c3856))
* **mobile:** keep the alert action washed for the whole hold, fire on release ([5d87c85](https://github.com/VoMinhKhoii/Kallo/commit/5d87c85c28154644f203ad1c5ac957b0773f15da))
...
* **mobile:** make a production build's grey screen reportable ([410d8b6](https://github.com/VoMinhKhoii/Kallo/commit/410d8b62551438f19a76eda21e28f5028df3d263))
...
* **mobile:** nutrient grid — let the figure yield, say "met" twice ([f6ffd68](https://github.com/VoMinhKhoii/Kallo/commit/f6ffd68c130f60d96264074e56cd37db6c8970d5))
* **mobile:** nutrient grid figure flush right, check glyph dropped ([c799ef9](https://github.com/VoMinhKhoii/Kallo/commit/c799ef95cba4f438e08937a5089a95b260fffe6e))
* **mobile:** order the seed and the push when opening over the shell ([d99d27d](https://github.com/VoMinhKhoii/Kallo/commit/d99d27de7e17c07f8d5361430e198eeb02b63756))
...
* **mobile:** say what the thread page will not show ([d8e933e](https://github.com/VoMinhKhoii/Kallo/commit/d8e933e9bab33ed7c3640effeed35cb4e8f1fbcc))
* **mobile:** the `/` picker keeps the keyboard, and fits under it ([7e340a9](https://github.com/VoMinhKhoii/Kallo/commit/7e340a9f45ef4fede759e07958b452a08701db88))
* **mobile:** the anchored menu stays above the keyboard and on screen ([e2afaff](https://github.com/VoMinhKhoii/Kallo/commit/e2afaff921ae13be069a110a4cf67d73ad3d8320))
* **mobile:** the announced post node opens the thread, and a scroll ends the wash ([aac12dd](https://github.com/VoMinhKhoii/Kallo/commit/aac12dd33b2b0d79ee5bb1d679ff21ecef0d2fdb))
* **mobile:** the card is fed before the picker, and a pick stays where it sat ([4de1ccd](https://github.com/VoMinhKhoii/Kallo/commit/4de1ccd674fd413efd4f4b0951c3025b2e071e8f))
* **mobile:** the feed stops chasing its own tail ([a643f63](https://github.com/VoMinhKhoii/Kallo/commit/a643f638cab98717ca29b60c502d2cbdb7c4de86))
* **mobile:** the field yields under a bounded dock, and the pin lets go on time ([379534d](https://github.com/VoMinhKhoii/Kallo/commit/379534d0eb30a827af32c0fe618822633d9e3567))
* **mobile:** the pre-auth flow keeps a back stack ([d3afb19](https://github.com/VoMinhKhoii/Kallo/commit/d3afb199f9764d1333926ac52f67669de7b7404f))
* **mobile:** thread page — docked composer, measured reserve, reply scope ([e4380c1](https://github.com/VoMinhKhoii/Kallo/commit/e4380c1f1d0db348c9b8e13d62684d00edd8a2ea))
* **push:** address review — serialize sign-out, iOS-only dispatch, key and token validation ([ad24758](https://github.com/VoMinhKhoii/Kallo/commit/ad2475897cc6bd59a93c853f4578c5711a2d27e2))
* **push:** keep the accepted token when its DELETE fails so sign-out can retry ([61f74a7](https://github.com/VoMinhKhoii/Kallo/commit/61f74a728df9761ec92fa44720483da2cff05b17))
* **push:** re-sign the provider token after a 403 rejection; one flat tap payload ([1ad8b08](https://github.com/VoMinhKhoii/Kallo/commit/1ad8b0801ff81f2739f48ae096a1c3ad6dec418a))
* **push:** serialize token registrations so sign-out releases the right row ([880d15b](https://github.com/VoMinhKhoii/Kallo/commit/880d15bc490ef4d58ef2f5174fac7e3a6f1d49df))
* reconcile production analytics migrations ([e44479b](https://github.com/VoMinhKhoii/Kallo/commit/e44479ba4c8ff4cb897a62bf67629405c32714aa))
* reconcile production analytics migrations ([0e1ddbd](https://github.com/VoMinhKhoii/Kallo/commit/0e1ddbdc8f42158ffb6df42f5d327df8114ed000))
* **social:** the single-share read goes through the one visibility gate ([bbb2de4](https://github.com/VoMinhKhoii/Kallo/commit/bbb2de48a8f0f1752bb86fb34934f057a2598064))
* **web:** Circle card reads like the post — kcal under the bar, replies on their page ([3b7fa81](https://github.com/VoMinhKhoii/Kallo/commit/3b7fa810e6e2eb4e656583ecab6bf743ca3925bf))
...
* **dashboard:** share the cell RECIPE, not just its colours ([bc61ba5](https://github.com/VoMinhKhoii/Kallo/commit/bc61ba5e89020d3dfb1ea4b3732d3b415451eccc))
* **dashboard:** type the heatmap tier, split the ramp, drop the policy out of the widget ([0b7aa8e](https://github.com/VoMinhKhoii/Kallo/commit/0b7aa8eb3d6dbd8b8dddbfea866edd5a599e0208))
* **logging:** the pick path says what it does, without shims ([2fb9e42](https://github.com/VoMinhKhoii/Kallo/commit/2fb9e42dbb52cf4be8cc1623435238c86455ea59))
* **mobile,web:** simplify the thread page, dock, and token plumbing ([2dde989](https://github.com/VoMinhKhoii/Kallo/commit/2dde989629ee7153e99449b659bd97d131f551ff))
* **mobile:** act on the structural review of this branch ([789e5e6](https://github.com/VoMinhKhoii/Kallo/commit/789e5e689a81898aa01ff0def06c70a47911ddb3))
* **mobile:** Circle cleanups from the review pass ([03b7449](https://github.com/VoMinhKhoii/Kallo/commit/03b744965c59345e838b957e22a08c2e51474b26))
* **mobile:** one definition of "met"; delete the dead status buckets ([b2c532c](https://github.com/VoMinhKhoii/Kallo/commit/b2c532c889505f6f39b3bd45530f12bf3a6c45ae))
* **mobile:** one KalloPressable behind the alert row and the feed action ([779da13](https://github.com/VoMinhKhoii/Kallo/commit/779da13b178d57b8885c0e81101d97bd4ccd913d))
* **mobile:** one MeasuredHeight for both self-measuring docks ([987a399](https://github.com/VoMinhKhoii/Kallo/commit/987a39948efbb78d97e1a81e7d20a733233dad6f))
* **mobile:** sealed thread view, thread states seam, splash out of router ([533cf8b](https://github.com/VoMinhKhoii/Kallo/commit/533cf8bac65313d65d19918953e3aab0b62252b6))
* **mobile:** shared widget tidy from the quality review ([c7ad578](https://github.com/VoMinhKhoii/Kallo/commit/c7ad578780a71c393b61ff9c2813b2ca9662e02e))
* **mobile:** the feed composes a post's navigation, one glyph state ([b0fd308](https://github.com/VoMinhKhoii/Kallo/commit/b0fd308ef24ca9ed76e65e2d2419965c12e7803b))
* **mobile:** the logging feature stops carrying state as loose scalars ([d586267](https://github.com/VoMinhKhoii/Kallo/commit/d58626760ef223b0c519a24ec63ab400b61b290a))
* **mobile:** the nutrition page picks its layout from the async state ([90e62c5](https://github.com/VoMinhKhoii/Kallo/commit/90e62c5f699a73f8aa5c5e2de305f9f28af8487d))
* **mobile:** thread page states are a sealed subtype, one share lookup ([0de9a6d](https://github.com/VoMinhKhoii/Kallo/commit/0de9a6de88e6af4506711e8f108f429aac0e64cb))
* **web:** Circle hrefs from one helper, thread-only replies under thread/ ([c1a8925](https://github.com/VoMinhKhoii/Kallo/commit/c1a89254e96de099886c040c166a8c742a380455))
* **web:** one-statement share read, seeded thread page, honest fiber bands ([f912ae6](https://github.com/VoMinhKhoii/Kallo/commit/f912ae60596e11cde471b04997ac6e812fe2e2cd))
* **web:** reading-tier ink through the token; un-couple the row test ([1da1910](https://github.com/VoMinhKhoii/Kallo/commit/1da191006dfdc238e447358adb646a17337d8924))


### Documentation

* bring the mobile docs in step with the swipe, the "+" and the closed store ([66e215a](https://github.com/VoMinhKhoii/Kallo/commit/66e215aeb339730efb08076e0e06bbdadbffcd95))
* list APNS_KEY_P8 in the Cloud Run secret-backed env inventory. ([880d15b](https://github.com/VoMinhKhoii/Kallo/commit/880d15bc490ef4d58ef2f5174fac7e3a6f1d49df))
* **mobile:** make "Cupertino wherever it exists" a design-system rule ([d13aade](https://github.com/VoMinhKhoii/Kallo/commit/d13aade406aed9066874a702a5851a22c3b5c3ec))
* record day_completion_marks and close heatmap follow-up 7 ([29922f7](https://github.com/VoMinhKhoii/Kallo/commit/29922f7ef06e6e23e1aefe37d5e161b156004641))
