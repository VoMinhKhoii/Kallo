...
import { BackgroundSection } from '~/components/nutrition/sections/background-section';
import { DailyRhythm } from '~/components/nutrition/sections/daily-rhythm';
import { EditorialHeader } from '~/components/nutrition/sections/editorial-header';
import { EmptyState } from '~/components/nutrition/states/empty-state';
import { FocusSection } from '~/components/nutrition/sections/focus-section';
import { InlineError } from '~/components/nutrition/states/inline-error';
import { NutritionSkeleton } from '~/components/nutrition/states/nutrition-skeleton';
import { PullQuote } from '~/components/nutrition/sections/pull-quote';
import { SteadySection } from '~/components/nutrition/sections/steady-section';
import { VerdictHero } from '~/components/nutrition/sections/verdict-hero';
import { useTranslations } from '~/i18n';
import { useNutritionOverview } from '~/lib/nutrition/hooks/use-nutrition-overview';
