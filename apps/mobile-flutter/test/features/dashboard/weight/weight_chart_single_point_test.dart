          ...
          (context) => MaterialApp(
            ...
            home: MediaQuery(
              ...
              child: const Scaffold(
                body: Center(
                  child: SizedBox(width: 320, child: WeightChart(args: _args)),
                ),
              ),
            ),
          ),
...
void main() {
  ...
  for (final scaler in const [TextScaler.noScaling, TextScaler.linear(1.3)]) {
    testWidgets('a single logged weight fits its axis at $scaler', (
      ...
      expect(
        tick.left,
        greaterThanOrEqualTo(chart.left - 0.01),
      ...
      expect(
        tick.height,
        greaterThanOrEqualTo(scaler.scale(14) * 1.25 - 0.01),
