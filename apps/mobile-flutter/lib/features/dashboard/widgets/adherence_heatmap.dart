        ...
        child: Column(
          ...
          children: [
            ...
            NhamButton(
              ...
              onPressed: () => ref.invalidate(dashboardBundleProvider(args)),
            ),
          ],
        ),
      ),
...
class _HeatmapBodyState extends State<_HeatmapBody>
  ...
  late final int _staggerMs = ((_numWeeks - 1) * 10 + 6 * 5 + 160)
      .clamp(160, 5000);
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: Stack(
                          children: [
                            for (final h in data?.monthHeaders ??
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                padding: const EdgeInsets.symmetric(
                                    vertical: NhamSpacing.sp1, horizontal: 6),
                                decoration: BoxDecoration(
                                  color: NhamColors.text,
                                  borderRadius:
                                      BorderRadius.circular(NhamRadii.sm),
                                ),
                                child: Text(
                                  _bubble!.text,
                                  textAlign: TextAlign.center,
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: ClipRRect(
                        borderRadius:
                            BorderRadius.circular(_legendBarHeight / 2),
                        child: Container(
  ...
  void _handleTap(
    ...
    final cell = (di < data.cells.length && wi < data.cells[di].length)
        ? data.cells[di][wi]
        : null;
    if (cell == null) return;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var wi = 0; wi < numWeeks; wi++) {
      for (var di = 0; di < 7; di++) {
        ...
        final rect = Rect.fromLTWH(cx - half, cy - half, sq * scale, sq * scale);
        final rrect =
