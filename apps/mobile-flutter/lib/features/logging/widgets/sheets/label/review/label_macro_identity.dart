...
///
/// The colours are the CHARTED set, not `KalloColors.macro*`. `nham_colors.dart`
...
///
/// Lives here rather than in `logic/label/nutrients.dart` so that file stays
...
const Map<String, LabelMacroIdentity> labelMacroIdentities = {
  'calories': LabelMacroIdentity(LucideIcons.flame300, KalloColors.accent),
