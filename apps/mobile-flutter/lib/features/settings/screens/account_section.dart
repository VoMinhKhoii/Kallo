...
/// Account section of the settings list: export data, sign out (with a
/// confirmation sheet), and permanent account deletion. Account deletion is an
/// App Store requirement whenever the app offers account creation.
