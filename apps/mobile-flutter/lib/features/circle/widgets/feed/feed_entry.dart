...
///
/// [_tight] binds a label to the thing it labels, [_standard] separates one
...
/// density.
///
/// [_standard] was sp3, matching the padding exactly — which left the meal name
...
const double _standard = KalloSpacing.sp2; // 8
