...
/// also what lets the empty state centre itself ([ThreadEmptySliver]).
///
/// It takes [KalloRefreshableScroll]'s `onDrag` keyboard dismissal on purpose,
...
/// The replies, indented onto the post author's own rail.
///
/// [GroupedListCard.contentInset] rather than a second copy of it: a reply's
/// avatar has to land under the POST AUTHOR's avatar, which sits at exactly
/// that inset inside the card above. It used to be `sp4 + kContentRail` (60) —
/// the post's CONTENT column, under its heart glyph rather than under its face,
/// which put the people answering a post a whole avatar-rail right of the
/// person who made it and read as a nested sub-thread.
class _RepliesSliver extends StatelessWidget {
  ...
  Widget build(BuildContext context) => SliverPadding(
    padding: const EdgeInsets.only(
      left: KalloSpacing.sp3 + GroupedListCard.contentInset,
