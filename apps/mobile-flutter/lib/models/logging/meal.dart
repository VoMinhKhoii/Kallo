  ...
  factory ParsedMeal.fromJson(Map<String, dynamic> json) => ParsedMeal(
    ...
    items:
        (json['items'] as List<dynamic>)
            ...
            .toList(),
    totalMacros: MacroBreakdown.fromJson(
      json['totalMacros'] as Map<String, dynamic>,
    ),
  );
...
class MealQuantityEdit {
  ...
  const MealQuantityEdit({required this.mealItemOrder, required this.newGrams});
  ...
  MealQuantityEdit copyWith({int? mealItemOrder, double? newGrams}) =>
      MealQuantityEdit(
