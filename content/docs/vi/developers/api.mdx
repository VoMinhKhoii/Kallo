...
và có thể được dịch. `retryable` trả lời đúng câu hỏi duy nhất mà một client tự
động thử lại thực sự cần: lặp lại y hệt yêu cầu này có bao giờ thành công không?
