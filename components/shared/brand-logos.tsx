/**
 * Third-party brand marks (sign-in providers). Google keeps its official
 * four-color mark; Apple renders in `currentColor` so it sits in the ink
 * palette wherever it's placed.
 */
