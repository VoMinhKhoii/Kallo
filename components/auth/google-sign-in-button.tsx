...
export function GoogleSignInButton() {
  ...
  return (
    <button
      ...
      disabled={loading}
      aria-busy={loading}
      className="flex w-full items-center justify-center gap-2.5 rounded-xl border border-[#E8D5B5] bg-white px-4 py-3 font-medium text-[#2C2416] text-sm tracking-tight transition-all duration-200 hover:bg-[#FFFCF8] disabled:opacity-60"
