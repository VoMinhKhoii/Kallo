...
export const LAB_COPY = {
  ...
  subtitle:
    "Tell Kallo what you ate the way you'd tell a friend — phở bò, avocado toast, last night's leftovers. It splits the sentence into real ingredients and derives calories and macros from food-composition data.",
  cta: 'Get started',
  ...
  globe: {
    ...
    genericBody:
      "Kallo speaks your food language too — type any dish the way you'd say it.",
