...
// three.js is client-only; while it loads (or if WebGL is missing) the
// hero stands on the production blobs, so there is no blank state.
const V2Scene = dynamic(
  () => import('./scene').then((module) => module.V2Scene),
