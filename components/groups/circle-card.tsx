...
const PHOTO_PLACEHOLDER_TINTS = [
  'from-[#e3c99a] via-[#d4a876] to-[#b98a5c]',
  'from-[#cbb89e] via-[#b39c81] to-[#8f7a63]',
  'from-[#ddd2c0] via-[#c4b6a0] to-[#a4917a]',
] as const;
...
/** A friend's shared meal, rendered as an ambient card or chat bubble. */
