 ...
 * surface's day-error pattern, using the warm `nham-danger` token.
 */
export function CircleError({
  ...
  return (
    <div className="flex items-center justify-center py-10">
      <div
        role="alert"
        className="w-full max-w-md rounded-2xl border border-nham-danger/30 bg-nham-danger/[0.06] p-4"
      >
