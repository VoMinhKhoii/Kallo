...
export function LoggedMealDetails({ meal }: { meal: HeroMeal }) {
  ...
  return (
    <div className="mt-5 border-kallo-border border-t pt-4">
        ...
        {meal.items.map((item) => (
          ...
          >
            ...
            <div className="flex shrink-0 items-center gap-1.5">
              <div className="flex gap-1 text-[9px] text-kallo-text tabular-nums">
      ...
      <div className="flex items-center justify-between border-kallo-border/50 border-t pt-3">
        <span className="font-bold font-sans-display text-[13px] text-kallo-text">
          {tTotal('total')}
        </span>
        <div className="flex items-center gap-4">
          <span className="font-sans-display text-[11px] text-kallo-text tabular-nums">
