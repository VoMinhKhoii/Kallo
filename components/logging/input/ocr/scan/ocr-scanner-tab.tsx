      ...
      {image.selectedFile && !image.error && (
        <div className="flex justify-end pt-2">
          <button
            ...
            className="inline-flex touch-manipulation items-center justify-center gap-2 rounded-xl bg-kallo-ink px-5 py-2.5 font-medium font-sans-display text-[14px] text-kallo-surface shadow-sm transition-colors hover:bg-[#1C1917] disabled:opacity-50"
          >
            {image.isProcessing ? (
              <>
