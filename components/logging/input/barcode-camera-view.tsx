...
export function BarcodeCameraView({
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="text-center font-sans-display text-[12px] text-nham-text-muted">
        {hasError && (
          <div
            role="alert"
          ...
          <div className="space-y-2">
            ...
            {cameras.length > 1 && (
              <select
                ...
                className="mx-auto block rounded-lg border border-nham-border bg-white px-2.5 py-1 text-xs"
              >
                {cameras.map((d, index) => (
