    ...
    <div className="grid grid-cols-1 gap-2.5 min-[380px]:grid-cols-2">
      {items.map((item) => {
        ...
        return (
          <div
            key={item.id}
            className="space-y-1 rounded-xl border border-nham-border bg-white p-3"
          >
            <label
              htmlFor={item.id}
            ...
            <div className="flex items-baseline gap-1">
              <Input
                ...
                className="h-8 w-16 border-none p-0 font-semibold text-[17px] text-nham-ink focus-visible:ring-0"
              />
