import type { DiagnosticStageStatus } from '@/lib/admin/diagnostics/types';
import { cn } from '@/lib/core/ui/cn';

// ---------------------------------------------------------------------------
// The shared visual atoms of the summary rail: status dots, stage rows,
// header metrics, chips, and the notice shown when a stage's output does not
// match the lenient schemas in `lib/admin/diagnostics/stage-schemas.ts`.
// ---------------------------------------------------------------------------
