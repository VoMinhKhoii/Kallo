...
| `20260925121000_add_ai_processing_consent.sql` | A (Drizzle) | `user_profiles.ai_processing_consented_at` — consent to third-party AI processing (App Store 5.1.2(i)); NULL = not consented, every AI entry point refuses with `ai_consent_required` |
