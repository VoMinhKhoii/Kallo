      ...
      <div className="min-h-full px-3 py-3 pb-24 sm:px-5 sm:py-4 lg:px-8 xl:h-full xl:min-h-0 xl:overflow-hidden xl:py-3 xl:pb-3">
        <div className="mx-auto grid max-w-[1440px] gap-3 xl:h-full xl:min-h-0 xl:grid-rows-[minmax(150px,0.78fr)_minmax(220px,1.1fr)_minmax(240px,1.12fr)]">
          ...
          <section className="flex min-h-0 flex-col gap-1.5">
            ...
            <div className="min-h-[150px] rounded-[1.375rem] border border-nham-border/60 bg-card p-4 shadow-[0_10px_32px_rgba(44,36,22,0.05)] xl:min-h-0 xl:flex-1">
          ...
          <section className="flex min-w-0 flex-col gap-1.5 xl:min-h-0">
            ...
            <div className="min-h-[220px] rounded-[1.375rem] border border-nham-border/60 bg-card p-4 shadow-[0_10px_32px_rgba(44,36,22,0.05)] xl:min-h-0 xl:flex-1">
          ...
          <section className="flex min-w-0 flex-col gap-1.5 xl:min-h-0">
            ...
            <div className="min-h-[310px] rounded-[1.375rem] border border-nham-border/60 bg-card p-3 shadow-[0_10px_32px_rgba(44,36,22,0.05)] sm:min-h-[340px] md:min-h-[360px] xl:min-h-0 xl:flex-1 xl:p-4">
